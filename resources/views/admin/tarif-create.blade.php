                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-select" id="wifi_id" type="text"
                                            ...
                                            value="{{ old('wifi_id') }}" required autocomplete="wifi_id" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="forfait" type="text"
                                            ...
                                            value="{{ old('forfait') }}" required autocomplete="forfait" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="montant" type="number"
                                            ...
                                            value="{{ old('montant') }}" required autocomplete="montant" autofocus>
