...
@section('content')
    <div id="content">
        ...
        <div class="container-fluid">
            <h3 class="text-dark mb-4">Modification du Wifi</h3>
            <div class="card shadow">
                <div class="card-header py-3">
                    <div class="d-flex">
                        <p class="text-primary m-0 fw-bold me-auto">Mise à jour des informations du wifi</p>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nom" type="text"
                                            ...
                                            value="{{ $data->nom }}" required autocomplete="nom" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="description" type="text"
                                            ...
                                            required autocomplete="description" autofocus>{{ $data->description }}</textarea>
