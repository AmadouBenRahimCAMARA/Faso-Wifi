...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <section class="page-section">
      <div class="container px-4 px-lg-5">
        <h2 class="text-center mt-0">Récupérer mon ticket dernier ticket</h2>
        <p class="text-muted mb-0 text-center">
          Obtenez votre dernier ticket acheté sur Enumera wifi zone
        </p>
        <hr class="divider" />
        <form class="row gx-4 gx-lg-5">
          <div class="col-12 col-md-6 mx-auto">
            <div class="form-floating mb-3">
              ...
              />
              <label for="name">Numéro téléphone utilisé pour faire le paiement</label>
          ...
          <div class="col-12 text-center mt-5">
            <a class="btn btn-primary btn-xl" href="#about">Continuer</a>
          </div>
        </form>
      </div>
    </section>
    ...
    <section class="page-section bg-dark text-white">
      <div class="container px-4 px-lg-5 text-center">
        <h2 class="mb-4">Obtenir un nouveau tichet de connexion</h2>
        <a
          class="btn btn-light btn-xl"
          href="{{route("acheter")}}"
          >Acheter un nouveau ticket</a
        >
      </div>
    </section>
    <!-- Contact-->
