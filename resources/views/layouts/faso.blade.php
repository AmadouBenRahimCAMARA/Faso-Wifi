...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center">
            <h1 class="logo me-auto"><a href="{{ route('index') }}">FASO WIFI<span>.</span></a></h1>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 footer-contact">
                        <h3>FASO WIFI<span>.</span></h3>
                        <p>
                            BURKINA FASO <br>
                            Bobo-Dioulasso<br>
                            Secteur 22 <br><br>
                            <strong>Téléphone:</strong> +226 20660249<br>
                            <strong>Email:</strong> info@fasowifi.com<br>
                        </p>
                    </div>
